...
\stitle {bivariate}{0.3.1}{Bivariate Probability Distributions}
...
\begin {enumerate}
	...
	\item Bivariate probability distributions resulting from kernel smoothing*.
\end {enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
I'm going to load (and attach) the bivariate and moments packages:
<<>>=
library (bivariate)
library (moments)
@
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section* {Bivariate Probability Distributions Resulting from Kernel Smoothing*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
